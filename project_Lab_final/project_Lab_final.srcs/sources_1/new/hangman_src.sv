...
module hangman_src   #(
   ...
   (
    ...
    input  logic [5:0] ctrl,    // sprite control 
   ...
   logic [CD-1:0] full_rgb, hangman_rgb;
   ...
   hangman_ram_lut #(.ADDR_WIDTH(ADDR), .DATA_WIDTH(2)) ram_unit (
   ...
   always_comb
      case (gc_color_sel)
         2'b00:   hangman_rgb = 12'hf00;  // red 
         2'b01:   hangman_rgb = 12'hf8b;  // pink 
         2'b10:   hangman_rgb = 12'hfa0;  // orange
         default: hangman_rgb = 12'h0ff;  // cyan
      endcase   
   // palette table
   always_comb
      case (plt_code)
         2'b00:   full_rgb = 12'h000;   // chrome key
         2'b01:   full_rgb = 12'h111;   // stick
         2'b10:   full_rgb = hangman_rgb; // human body
